  ...
  <?php
    ...
    if ($query_run) {
      ...
      while ($row = mysqli_fetch_assoc($query_run)) {
        ...
        echo "<td class='delete'><button type='button' class='btn btn-danger delete-btn'>Delete</button></td>";
...
$('.delete-btn').click(function() {
  ...
  var catererId = $(this).closest('tr').find('td:first').text();
  
  // Send an AJAX request to delete the event from the database
  $.ajax({
    url: 'delete_caterer.php',
    method: 'POST',
    data: { catererId: catererId },
