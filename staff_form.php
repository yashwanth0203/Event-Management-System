...
<body>
      ...
      <div class="subtitle">Add the Staff</div>
      <div class="input-container ic1">
        <input type="text" placeholder="Name" name="s_name" class="form-control required" required />
      </div>
      <div class="input-container ic2">
        <input type="email" placeholder="Email" name="s_email" class="form-control required" required />
      </div>
